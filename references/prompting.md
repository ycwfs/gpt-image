...
- logo-brand: Use this only for raster concept exploration, not for final editable vector delivery. Keep it simple and scalable; ask for a strong silhouette and balanced negative space; avoid decorative flourishes unless requested.
