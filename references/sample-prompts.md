...
Use this only for raster infographic output or visual exploration. If the user needs editable vector/diagram source, do not use this skill.
```
...
Use this only for raster logo exploration or moodboarding. If the user needs an editable SVG or production vector logo, do not use this skill.
```
Use case: logo-brand
...
Use this only for raster mockups. If the user needs an editable HTML/CSS, SVG, or draw.io wireframe, do not use this skill.
```
Use case: ui-mockup
